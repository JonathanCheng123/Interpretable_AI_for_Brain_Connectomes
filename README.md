...
We model the connectomes as a 379 x 379 connectivity matrix, where each entry represents the functional connectivity between 2 brain regions. The 379 regions consist of the 360 cortical regions defined by the HCP Multi-Modal Parcellation (HCP-MMP1.0) plus 19 subcortical structures. The HCP-MMP cortical parcellation is documented at: https://neuroimaging-core-docs.readthedocs.io/en/latest/pages/atlases.html
